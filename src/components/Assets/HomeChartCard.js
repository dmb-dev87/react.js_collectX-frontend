...
export default class HomeChartCard extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            con_data: '',
...
export class HomeChartCard2 extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            con_data: '',
    ...
    render() {
        ...
        return (
            <Card className="card-plain home-card-chart">
                <CardBody className="card-body-no-padding">
                    <Line data={con_data} options={options} width={363} height={171}/>
                </CardBody>
            </Card>
        );
    }
